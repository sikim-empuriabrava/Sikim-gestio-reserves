...
- En platos, el campo UI `notes` quedó alineado temporalmente con `cheffing_dishes.description` para evitar updates contra una columna `notes` inexistente en producción.
