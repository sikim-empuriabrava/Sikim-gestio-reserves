  ...
  return (
    <div className="space-y-5">
      ...
      <OperationalPanel className="p-4">
        <div className="flex flex-wrap items-center gap-3 text-sm text-[#d8cfc2]">
          <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.16em] text-[#a99d90]">
          ...
          <select
            ...
            className={`${operationalFieldClass} max-w-[14rem] py-2`}
          >
            <option value="all">Todas</option>
            <option value="routine">Rutinas</option>
            <option value="incident">Incidencias</option>
          </select>
          <span className="ml-auto rounded-full border border-[#4a3f32]/70 bg-[#151412]/70 px-3 py-1 text-xs text-[#a99d90]">
