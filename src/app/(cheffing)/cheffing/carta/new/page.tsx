...
import { CheffingConsumerEditor, cardHeaderDefaults } from '@/app/(cheffing)/cheffing/components/CheffingConsumerEditor';
...
export default async function CheffingCartaNewPage() {
  ...
  return (
    <section className="space-y-6 rounded-2xl border border-slate-800/80 bg-slate-900/70 p-6">
      ...
      <CheffingConsumerEditor mode="card" id={null} header={cardHeaderDefaults} items={[]} dishes={dishes} />
    </section>
  );
}
